...
$action = $isEdit ? '/admin/categories/' . (int)$item['id'] . '/update' : '/admin/categories';
?>
...
<?php if ($isEdit): ?><form method="post" action="/admin/categories/<?= e((string)$item['id']) ?>/delete" style="margin-top:10px;"><?= csrf_field() ?><button class="danger" type="submit">Delete</button></form><?php endif; ?></div>
